-- ═══════════════════════════════════════════════════════════════════════════════
-- NOT MY STYLE - Database Schema (PostgreSQL / Supabase Version) — FIXED
...
CREATE TABLE "Users" (
    ...
    "Role"            VARCHAR(20)  NOT NULL DEFAULT 'player'
                          CHECK ("Role" IN ('player', 'developer')),
    "Lives"           INT          NOT NULL DEFAULT 3
                          CHECK ("Lives" >= 0 AND "Lives" <= 3),
    "TotalScore"      INT          NOT NULL DEFAULT 0,
    "LevelsPlayed"    INT          NOT NULL DEFAULT 0,
...
CREATE TABLE "LevelPropertyConfigs" (
    ...
    "InitialValue"   VARCHAR(100) NOT NULL,
